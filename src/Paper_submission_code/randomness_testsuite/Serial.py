...
class Serial:
#changed default pattern length to 9; it is required that m < log_2 n -2, so you may need to set the pattern length to smaller if necessary. 
    @staticmethod
    def serial_test(binary_data:str, verbose=False, pattern_length=9):
        """
