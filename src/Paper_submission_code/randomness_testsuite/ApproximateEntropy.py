...
#Default pattern length is 5!
    @staticmethod
    def approximate_entropy_test(binary_data:str, verbose=False, pattern_length=5):
        """
        ...
        # Charlie: it seems to work totally fine if you do it as its meant to be
        binary_data += binary_data[:pattern_length - 1:]
        ...
        #I think this command might be wrong. int command returns a string of 0s or 1s, adds 1, converts
        #to a string of 0s of length 0 and 1? this really makes no sense.
